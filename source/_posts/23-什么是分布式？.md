...
toc: false
mathjax: false
summary: 分布式系统不可能同时满足一致性（C：Consistency）、可用性（A：Availability）和分区容忍性（P：Partition Tolerance），最多只能同时满足其中两项。
categories: 转载
tags:
- 转载
- 文章
...
- [Distributed locks with Redis(opens new window)](https://redis.io/topics/distlock)
- [浅谈分布式锁(opens new window)](http://www.linkedkeeper.com/detail/blog.action?bid=1023)
- [基于 Zookeeper 的分布式锁(opens new window)](http://www.dengshenyu.com/java/分布式系统/2017/10/23/zookeeper-distributed-lock.html)
- [聊聊分布式事务，再说说解决方案(opens new window)](https://www.cnblogs.com/savorboard/p/distributed-system-transaction-consistency.html)
- [分布式系统的事务处理(opens new window)](https://coolshell.cn/articles/10910.html)
- [深入理解分布式事务(opens new window)](https://juejin.im/entry/577c6f220a2b5800573492be)
- [What is CAP theorem in distributed database system?(opens new window)](http://www.colooshiki.com/index.php/2017/04/20/what-is-cap-theorem-in-distributed-database-system/)
- [NEAT ALGORITHMS - PAXOS(opens new window)](http://harry.me/blog/2014/12/27/neat-algorithms-paxos/)
- [Paxos By Example](